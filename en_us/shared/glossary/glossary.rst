...
**Learning Sequence**
  ...
  page. The learning sequence contains an icon for each unit in the selected
  subsection. When a learner moves the cursor over one of these icons, the
  names of each component in the unit appear.
 
**Left Pane**

  The left navigation frame in the courseware that shows the sections and
  subsections for a course. When you click a section, the section expands to
  show subsections.
